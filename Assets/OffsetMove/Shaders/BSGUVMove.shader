...
Shader "Shadero Customs/BSG UV Move"
{
Properties
{
...
{
float2 AnimatedOffsetUV_1 = AnimatedOffsetUV(i.texcoord,AnimatedOffsetUV_X_1,AnimatedOffsetUV_Y_1,1,1,AnimatedOffsetUV_Speed_1);
